...
class SaveReminderViewModel(val app: Application, val dataSource: ReminderDataSource) :
    ...
    fun setTitle(title: Editable) {
        _reminderTitle.value = title.toString()
    }

    fun setDescription(description: Editable) {
        _reminderDescription.value = description.toString()
    }

    fun setSelectedLocationStr(selectedLocationStr: String?) {
        _reminderSelectedLocationStr.value = selectedLocationStr
    }

    fun setSelectedPOI(selectedPOI: PointOfInterest?) {
